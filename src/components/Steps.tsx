...
export default function Steps() {
  return (
    <section id="how" className="bg-light py-20">
      <div className="mx-auto max-w-[1120px] px-6">
        ...
        <RevealGroup className="grid grid-cols-1 gap-7 md:grid-cols-3">
          {STEPS.map((step) => (
            <motion.div
              key={step.num}
              variants={fadeUp}
              whileHover={{ y: -6 }}
              className="rounded-2xl border border-line bg-white p-9 shadow-sm transition-shadow duration-300 hover:shadow-[0_18px_40px_rgba(18,53,127,.08)]"
            >
              <motion.div
